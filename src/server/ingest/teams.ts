...
export const NFL_TEAM_SEED: CanonicalTeamSeed[] = [
  { name: 'Arizona Cardinals', city: 'Arizona', abbreviation: 'ARI', conference: 'NFC', division: 'West' },
  ...
  { name: 'Carolina Panthers', city: 'Carolina', abbreviation: 'CAR', conference: 'NFC', division: 'South' },
  ...
  { name: 'Minnesota Vikings', city: 'Minnesota', abbreviation: 'MIN', conference: 'NFC', division: 'North' },
  ...
  { name: 'Tennessee Titans', city: 'Tennessee', abbreviation: 'TEN', conference: 'AFC', division: 'South' },
  { name: 'Washington Commanders', city: 'Washington', abbreviation: 'WAS', conference: 'NFC', division: 'East' },
];

export const TEAM_ALIAS_TO_ABBR: Record<string, string> = NFL_TEAM_SEED.reduce<Record<string, string>>(
  (acc, team) => {
