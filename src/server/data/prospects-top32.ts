...
export const TOP_50_PROSPECTS: ProspectSeed[] = [
  ...
  {
    id: 'brandon-cisse-south-carolina',
    rank: 36,
    name: 'Brandon Cisse',
    position: 'CB',
  ...
  {
    id: 'chris-brazzell-ii-tennessee',
    rank: 37,
