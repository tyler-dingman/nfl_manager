    ...
    <AppShell>
      <div className="mb-6 flex flex-col gap-2">
        <div className="flex items-center gap-3">
          <FalcoAvatar size={28} />
          <h1 className="text-2xl font-semibold text-foreground">Down & Distance Big Board</h1>
        </div>
        ...
        <section className="rounded-3xl border border-border bg-card/60 p-4 shadow-sm md:p-6">
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <FalcoAvatar size={28} />
              <div>
                <div className="text-base font-semibold text-foreground">Down & Distance Takes</div>
