...
export function CapSpaceTable({
  ...
  return (
    <div
      className="fo-cap-table overflow-x-auto"
      role="region"
      aria-label="Cap space table, scroll for all columns"
      tabIndex={0}
    >
        ...
        {rows.map((row) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={cn('text-sm font-medium', isOverCap && 'text-red-600 font-semibold')}
              >
