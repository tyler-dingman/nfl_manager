...
export default function TeamHeaderSummary({
  ...
  return (
    <section
      ...
      style={{
        backgroundColor: 'color-mix(in srgb, var(--team-primary) 6%, white)',
    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-6">
        <div>
          ...
          <h2 className="mt-2 text-xl font-semibold text-foreground">Cap and roster overview</h2>
        ...
        <div className="flex flex-wrap items-center gap-6">
          <div className="min-w-[150px]">
            <div className="flex items-center justify-between text-sm">
              <span className="font-semibold text-foreground">{formatCap(capSpace)}</span>
              <span className="text-muted-foreground">{formatCap(capLimit)} limit</span>
            </div>
          ...
          <div className="min-w-[150px]">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="text-muted-foreground">{rosterLimit - rosterCount} open</span>
            </div>
            <div className="mt-2 h-2 rounded-full bg-slate-200">
              <div
                className="h-2 rounded-full"
          ...
          <div className="min-w-[120px]">
            <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Cap trend</p>
