...
export const TEAM_BRAND_THEMES: Record<string, TeamBrandTheme> = {
  ...
  ATL: { primary: '#A71930', secondary: '#A71930', dark: '#000000', light: '#FFFFFF' },
  ...
  CIN: { primary: '#FB4F14', secondary: '#FB4F14', dark: '#000000', light: '#FFFFFF' },
  CLE: { primary: '#311D00', secondary: '#FF3C00', dark: '#1C1000', light: '#FFFFFF' },
  DAL: { primary: '#041E42', secondary: '#869397', dark: '#001733', light: '#FFFFFF' },
  DEN: { primary: '#FB4F14', secondary: '#FB4F14', dark: '#00152B', light: '#FFFFFF' },
  DET: { primary: '#0076B6', secondary: '#0076B6', dark: '#08162A', light: '#FFFFFF' },
  ...
  NO: { primary: '#D3BC8D', secondary: '#D3BC8D', dark: '#101820', light: '#FFFFFF' },
  NYG: { primary: '#0B2265', secondary: '#A71930', dark: '#06163E', light: '#FFFFFF' },
  NYJ: { primary: '#125740', secondary: '#125740', dark: '#0A3226', light: '#FFFFFF' },
