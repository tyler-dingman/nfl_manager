    ...
    <SafeAreaView style={s.page}>
      <KeyboardAvoidingView style={s.page} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        ...
        >
          ...
          <Text style={s.copy}>
            Sign in to keep your team, stories, trivia, and rewards in sync.
          </Text>
          {appleAvailable && Platform.OS === 'android' ? (
            <Pressable
              style={s.appleAndroid}
              disabled={busy}
          ...
          {googleAvailable ? (
            <Pressable style={s.google} disabled={busy} onPress={() => void signInWithGoogle()}>
          ...
          <View style={s.divider}>
            <View style={s.line} />
            <Text style={s.or}>OR USE YOUR D&amp;D ACCOUNT</Text>
            <View style={s.line} />
          </View>
          <TextInput
            style={s.input}
          ...
          />
          <Pressable
            style={[s.emailButton, (!email || !password || busy) && s.disabled]}
          ...
          {!appleAvailable && !googleAvailable ? (
            <Text style={s.setup}>
              Apple and Google require their provider configuration. Email sign-in works with your
              existing D&amp;D account for local testing.
            </Text>
          ) : null}
...
const s = StyleSheet.create({
  ...
  appleText: { color: '#fff', fontWeight: '800', fontSize: 16 },
  ...
  emailButtonText: { color: C.white, fontWeight: '900', letterSpacing: 1 },
  disabled: { opacity: 0.5 },
  setup: { color: C.muted, lineHeight: 20, textAlign: 'center', marginTop: 20 },
  busy: { marginTop: 18 },
